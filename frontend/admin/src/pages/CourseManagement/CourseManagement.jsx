// frontend/admin/src/pages/CourseManagement/CourseManagement.jsx
...
export default function CourseManagement() {
  ...
  const stats = [
    ...
    {
      label: 'Instructors',
      value: new Set(courses.map(c => c.instructor)).size.toString(),
      icon: Users,
      color: 'green'
    }
  ];
    ...
    <div className="course-management-page">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Manage courses and class schedules</p>
        </div>
